...
import UserDetailModal, { UserReferralModal } from "./UserDetailModal";
import ShowAvatar, {
  NoData,
  TextAndIcon
...
const [UserDetailModal, setUserDetailModal] = useState({open:false,data:null})
          ...
          {tableData?.length ? (
            <>
              <UserTable
                ...
                setShowUserDetailModal={setUserDetailModal}
          ...
          {tableData?.map((row, index) => (
            <StyledTableRow key={row._id}>
              ...
              <StyledTableCell align="left">
                <Typography fontWeight="bold">{row?.email} </Typography>
              </StyledTableCell>
...
navigate("/user-detail/"+row?._id)
      ...
      {showModal.open && <UserReferralModal
        pageReloader={pageReloader}
        showModal={showModal}
        setShowModal={setShowModal}
      />}
      {ShowUserDetailModal.open && <UserDetailModal
        pageReloader={pageReloader}
        showModal={ShowUserDetailModal}
        setShowModal={setShowUserDetailModal}
      />}
    </TableContainer>
  );
};
